!***********************************************************************
! Combined NSST routines for MPAS/GFS physics coupling
!
! Source files combined in this order:
!   1. sfc_nst_pre.f90
!   2. sfc_nst.f90
!   3. sfc_nst_post.f90
!
! Keep this file in the physics source directory and add it to the
! physics build list.  The routines themselves are otherwise unchanged.
!***********************************************************************


!=======================================================================
! BEGIN original file: sfc_nst_pre.f90
!=======================================================================
...
contains
  ...
  subroutine sfc_nst_pre_run                      &
    ...
    if (cplflx) then
       z_c_0 = zero
       call get_dtzm_2d (xt, xz, dt_cool, z_c_0, wet, real(zero,kind=kind(dt_cool)), omz1, im, 1, nthreads, dtzm)
       do i=1,im
...
!=======================================================================
! END original file: sfc_nst_pre.f90
!=======================================================================


!=======================================================================
! BEGIN original file: sfc_nst.f90
!=======================================================================
...
module sfc_nst
  ...
  use gfs_tke_edmf_machine ,               only : kind_phys, kp => kind_phys
...
!=======================================================================
! END original file: sfc_nst.f90
!=======================================================================


!=======================================================================
! BEGIN original file: sfc_nst_post.f90
!=======================================================================
...
!=======================================================================
! END original file: sfc_nst_post.f90
!=======================================================================
